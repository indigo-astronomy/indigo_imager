...
HEADERS += \
	viewer_src/version.h \
	viewer_src/viewerwindow.h \
	viewer_src/conf.h \
	common_src/utils.h \
...
INCLUDEPATH += "$${PWD}/indigo/indigo_libs" + "$${PWD}/external" + "$${PWD}/external/qtzeroconf/" + "$${PWD}/common_src" + "$${PWD}/viewer_src"
