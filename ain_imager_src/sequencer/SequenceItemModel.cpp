...
void SequenceItemModel::initializeModel() {
	...
	widgetTypeMap = {
		...
		{"select_frame_type", {"Select Frame Type", {{0, {"Frame Type", "QComboBox"}}}}},
		{"select_image_format", {"Select Image Format", {{0, {"Image Format", "QComboBox"}}}}},
		{"select_camera_mode", {"Select Camera Mode", {{0, {"Camera Mode", "QComboBox"}}}}},
		{"select_filter", {"Select Filter", {{0, {"Filter", "QComboBox"}}}}},
		...
		{"enable_cooler", {"Enable Cooler", {{0, {"Temperature (°C)", "QDoubleSpinBox"}}}}},
		{"disable_cooler", {"Disable Cooler", {}}},
		{"enable_dithering", {"Enable Dithering", {{0, {"Amount (px)", "QSpinBox"}}, {1, {"Time Limit (s)", "QSpinBox"}}, {2, {"Skip Frames", "QSpinBox"}}}}},
		...
		{"capture_batch", {"Capture Batch", {{0, {"Count", "QSpinBox"}}, {1, {"Exposure (s)", "QDoubleSpinBox"}}}}},
		{"focus", {"Focus", {{0, {"Exposure (s)", "QDoubleSpinBox"}}}}},
		{"focus_ignore_failure", {"Focus (continue on failure)", {{0, {"Exposure (s)", "QDoubleSpinBox"}}}}},
		...
		{"calibrate_guiding", {"Calibrate Guiding", {{0, {"Exposure (s)", "QDoubleSpinBox"}}}}},
		{"start_guiding", {"Start Guiding", {{0, {"Exposure (s)", "QDoubleSpinBox"}}}}},
		{"stop_guiding", {"Stop Guiding", {}}},
		{"clear_guider_selection", {"Clear Guider Selection", {}}},
		{"sync_center", {"Sync Center", {{0, {"Exposure (s)", "QDoubleSpinBox"}}}}},
		{"precise_goto", {"Precise Goto", {{0, {"Exposure (s)", "QDoubleSpinBox"}}, {1, {"RA", "QLineEditSG-RA"}}, {2, {"Dec", "QLineEditSG-DEC"}}}}},
